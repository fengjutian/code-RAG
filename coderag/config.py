...
# DeepSeek API key and model settings (loaded from .env)
DEEPSEEK_API_KEY = os.getenv("DEEPSEEK_API_KEY")
DEEPSEEK_EMBEDDING_MODEL = os.getenv(
    "DEEPSEEK_EMBEDDING_MODEL", "text-embedding-ada-002"
)  # Default to ada-002 compatible model
DEEPSEEK_CHAT_MODEL = os.getenv("DEEPSEEK_CHAT_MODEL", "deepseek-chat")  # Default to deepseek-chat
DEEPSEEK_API_BASE = os.getenv("DEEPSEEK_API_BASE", "https://api.deepseek.com/v1")  # Default to DeepSeek API base URL (with /v1 suffix)
...
WATCHED_DIR = os.getenv("WATCHED_DIR", os.getcwd())
